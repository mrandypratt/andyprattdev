...
export const BOOKS: Book[] = [
  {
    ...
    finished: "2021",
    take:
      "My favorite book of all time: history, technology, biology, human nature, and wonder are all tied together in this audacious and sweeping tour of how information and the ability for humans to communicate that information have shaped the technology and society of today. The narrative style flows smoothly between topics and chapters that makes the density of the concepts easy to digest. Truly a mind-opening book and a must-read for engineers, especially in software. I would love to see a new chapter on AI if you’re reading, James!",
  },
  {
    title: "Sapiens",
  ...
  },
  {
    ...
    finished: "2024",
    take:
      "It’s a wonder I ever finished this book. I do most of my reading to transition into sleep, and there is no better book to help with that than one that enumerates the countless benefits of sleep. All the information in the book _should_ be intuitive, but the author’s dive into the mechanism and physiological benefits of sleep are both informative and a great reminder that we cannot be at our best if we aren’t getting our rest!",
  },
  {
  ...
  },
  {
    ...
    finished: "2026",
    take:
      "I listened to about a third of this audio book and got a great deal of gems. The ability to speak in “I” statements and speak to the emotions that one feels is critical for any worth my all long-term relationship but also serves well on many occasions. This book gives the tools to be able to talk about conflict in a way that lowers defenses and creates the opportunity for both the speaker and the listener to feel seen and heard.",
  },
  {
  ...
  },
  {
    ...
    finished: "2025",
    take:
      "Bill Bryson has a penchant for making everything he talks about dryly funny and interesting. A Walk in the Woods is pure entertainment value buddy-comedy of two guys hiking the Appalachian Trail with curiosity, profundities, and wholesome moments sprinkled throughout Bryson’s signature narrative wit and humor. ",
  },
  {
    title: "The Martian",
    author: "Andy Weir",
